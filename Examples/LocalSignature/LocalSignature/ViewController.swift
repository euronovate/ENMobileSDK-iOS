    ...
    func buildMobileSDK() {
        ...
        Task {
            let mobileSDK = await ENMobileSDK
                ...
                enMobileSDKConfig: ENMobileSDKConfig(enabledLanguages: [.en, .el], certificateSourceType: .autoGenerated, certificateOwnerInfo: .init(), networkConfig: networkConfig, keepScreenAlwaysOn: false, considerAllSignatureFieldCharacters: false))
